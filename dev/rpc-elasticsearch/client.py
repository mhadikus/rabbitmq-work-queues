...
class RpcClient:
    ...
    def on_response(self, ch, method, props, body: bytes):
        ...
        if self.corr_id == props.correlation_id:
            try:
                # The response body contains the task ID
                # TODO: Read data from Elasticsearch
    ...
    def send_request(self, taskId: uuid.UUID) -> dict:
        ...
        self.channel.basic_publish(
            exchange='',
            routing_key='my-rpc-elasticsearch-queue',
...
# Usage: python -m dev.rpc-elasticsearch.client
def main():
