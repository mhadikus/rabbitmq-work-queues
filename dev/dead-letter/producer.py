...
def start_producer():
    try:
        ...
        result = channel.queue_declare(queue='my-work-queue', durable=True)
        ...
        produce_work(channel, number_of_tasks, number_of_errors)
...
def produce_work(channel, number_of_tasks=1, number_of_errors=0):
